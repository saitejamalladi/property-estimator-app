...
export const DEFAULT_CONFIG: Config = {
  ...
  "metrics": {
    ...
    "public_transport": {
      ...
      "options": [
        {
          "id": "within_suburb_10m",
          "label": "Within suburb or ≤ 10 min",
          "value": 1.5
        },
        {
          "id": "neighbour_20m",
          "label": "Neighbour suburbs or ≤ 20 min",
          "value": 1,
          "default": true
        },
        {
          "id": "none_20m",
          "label": "No public transport within 20 min",
          "value": 0.75,
          "gateFail": true
        }
      ]
    ...
    "house_quality": {
      ...
      "options": [
        ...
        {
          "id": "within_8_years",
          "label": "Within 8 years old",
          "value": 1,
          "default": true
        },
        {
          "id": "8_15_years",
          "label": "8-15 years old",
          "value": 0.8
        },
        {
          "id": "over_15_years",
          "label": "More than 15 years old",
          "value": 0.75,
          "gateFail": true
        }
      ]
    ...
    "indian_community": {
      ...
      "options": [
        ...
        {
          "id": "very_low",
          "label": "Very Low or No Community",
          "value": 0.75,
          "gateFail": true
        }
      ]
